    ...
    return (
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-green-950/20 via-black to-emerald-950/20 opacity-50"></div>
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-green-500/10 rounded-full blur-[120px] animate-pulse"></div>
                    <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-emerald-500/10 rounded-full blur-[100px] animate-pulse [animation-delay:1s]"></div>
                </div>
                ...
                <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <p className="text-2xl md:text-3xl font-bold text-slate-300 max-w-3xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 [animation-delay:500ms]">
                        Where AI meets <span className="text-green-400">pixel-perfect stickers</span>
                    </p>
                    ...
                    <button
                        ...
                        className="group inline-flex items-center gap-3 px-10 py-5 bg-green-600 text-white text-xl font-black rounded-[2rem] hover:bg-green-500 transition-all shadow-[0_0_40px_-10px_rgba(34,197,94,0.6)] hover:shadow-[0_0_60px_-10px_rgba(34,197,94,0.8)] active:scale-95 animate-in fade-in zoom-in-95 duration-700 [animation-delay:900ms]"
                    >
            ...
            <section className="relative py-32 px-6 bg-gradient-to-b from-black via-slate-950 to-black">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-5xl md:text-6xl font-black text-center mb-20 bg-clip-text text-transparent bg-gradient-to-r from-white to-green-400">
                        Built for creators who demand perfection
                    </h2>

                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Feature 1 */}
                        <div className="group relative bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-[2rem] p-8 hover:border-green-500/50 transition-all duration-500 hover:shadow-[0_0_40px_-10px_rgba(34,197,94,0.3)]">
            ...
            <section className="relative py-32 px-6">
                ...
                <div className="relative max-w-4xl mx-auto text-center space-y-8">
                    <h2 className="text-5xl md:text-6xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white to-green-400">
